"""
FinSolve Technologies — MongoDB Departments Repository
"""
...
from backend.app.db.mongo import get_departments_collection, get_users_collection
...
def delete_department_record(dept_id: str):
    ...
    if count > 0:
        raise ValueError(
            f"Cannot delete department '{dept_id}' because {count} user(s) are currently assigned to it. "
